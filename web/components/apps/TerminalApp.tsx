...
export function TerminalApp() {
  ...
  return (
    <main className="mx-auto px-6" style={{ maxWidth: 1240, padding: "clamp(26px, 4vw, 40px) 24px 48px" }}>
      {/* ---- TOP: caller search ---- */}
        ...
        <aside className="term-left">
          <div className="term-sticky">
            ...
            <div className="side-card" style={{ padding: 0, overflow: "hidden" }}>
              <div className="tape-band" style={{ height: 52, borderRadius: 0, display: "flex", alignItems: "flex-end", padding: "0 14px 8px" }}>
                <span className="label" style={{ color: "var(--dark-ink)", opacity: 0.85 }}>side a · running</span>
              </div>
        ...
        <div className="term-center">
          ...
          {shown.length > 0 && (
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {shown.map((c, i) => (
                <div key={c.id} className="appear" style={{ animationDelay: `${Math.min(i, 8) * 40}ms` }}>
